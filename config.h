...
/* Timestamping and logging configuration. */
#ifndef BMS_PRODUCTION_BUILD
#define BMS_PRODUCTION_BUILD             (0U)
#endif

#if (BMS_PRODUCTION_BUILD != 0U)
#define BMS_LOG_MIN_LEVEL_VALUE          (1U) /* INFO */
#else
#define BMS_LOG_MIN_LEVEL_VALUE          (0U) /* DEBUG */
#endif
